 ...
 * @date 2023/5/5
 */
public class ColumnMeta extends AbstractMeta implements SerializableByte {
    /**
     * 所有字段占用字节(包含自身)
     */
    ...
    public ColumnMeta(int tableId, long startPos, Column columnDto) {
    ...
    public ColumnMeta(ByteBuffer byteBuffer) {
