...
import com.moyu.xmz.terminal.jline.MyLineReaderImpl;
import com.moyu.xmz.terminal.jline.TabCompleter;
import com.moyu.xmz.terminal.sender.TcpDataSender;
...
public class TcpTerminal {
    ...
    private void execSelectCommandGetResult(Integer databaseId, String sql, LineReader reader) {
        try (Socket socket = new Socket(this.ipAddress, this.port);
            ...
            // 命令类型
            dataOutputStream.writeByte(CmdTypeConstant.DB_QUERY_PAGE);
            // 数据库id
